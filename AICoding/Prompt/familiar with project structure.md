——任务：我希望你能够仔细的先预览一下这整个项目，并生成SKILL记录，同时做一个plan来修改var（这个任务比较复杂，需要你好好理解与思考，并权衡利弊选出最合适的方案）。
...
现在我使用了连续vae，如何自回归呢？这个时候我找到了一篇论文，代码在/mar中,它就是连续vae做自回归的典范，你可以先熟悉一下它是怎么做的。然后做一个plan。
...
我现在在想的是stage1用的哪个数据训练的，var就必须也要用同样的数据吗？
